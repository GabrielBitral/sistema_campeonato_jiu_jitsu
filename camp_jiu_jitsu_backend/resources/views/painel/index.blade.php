                ...
                <div class="col dropdown d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            ...
                            <a class="dropdown-item text-end" href="login_painel">
                                <small>Sair</small>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="menu">
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            ...
                            <a href="painel" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
                ...
                <div class="item-camp">
                    ...
                    <div class="collapse" id="menu-camp">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="cadastrar_campeonato" class="submenu-link link-light text-decoration-none rounded p-2">
                                <small class="d-flex justify-content-between align-items-center">
                                    Cadastrar
                                </small>
                            </a>
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="cadastrar" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>
                    ...
                    <div class="row align-items-end row-gap-4">
                        <div class="col-3 d-flex flex-wrap">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control bg-dark text-light border-dark"
                                    id="search" placeholder="Ex: Admin">
                            </div>
                        </div>
                        ...
                        <div class="col-5 row">
                            ...
                            <div class="col-6 d-flex gap-2">
                                ...
                                <input type="text" class="form-control bg-dark text-light border-dark"
                                    id="de" placeholder="27/10/2023">
                            </div>

                            <div class="col-6 d-flex gap-2">
                                <label for="ate" class="col-form-label">Até:</label>
                                <input type="text" class="form-control bg-dark text-light border-dark"
                                    id="ate" placeholder="27/10/2023">
                            </div>
                        </div>
