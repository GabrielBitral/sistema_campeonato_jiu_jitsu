        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-[80vh] lg:py-0">
            ...
            <div class="w-full p-6 bg-white rounded-lg shadow md:mt-0 sm:max-w-md sm:p-8">
                ...
                <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                    ...
                    <div>
                        <label for="confirmas_senha" class="block mb-2 text-sm font-medium text-gray-900">Confirmar
                            senha</label>
                        <input type="password" name="confirmas_senha" id="confirmas_senha" placeholder="**********"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            required="" />
                    </div>
                    <button type="submit"
