                    ...
                    <ul class="mt-2">
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Mateus Marinho
                                <span class="block text-blue-700 font-normal text-sm">Equipe Cobra Kai</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Vinicius Medeiros
                                <span class="block text-blue-700 font-normal text-sm">Equipe Talismã</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                João Veiga
                                <span class="block text-blue-700 font-normal text-sm">Equipe Nigerundayo</span>
                            </p>
                        </li>
                    </ul>
                </div>
                <div class="text-gray-900">
                    ...
                    <ul class="mt-2">
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Joyce Ribeiro
                                <span class="block text-blue-700 font-normal text-sm">Equipe Miyagi-do</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                        ...
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Luize Gama
                                <span class="block text-blue-700 font-normal text-sm">Equipe Mugiwara</span>
                            </p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="text-gray-900">
                    ...
                    <ul class="mt-2">
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Alcione Nazareth
                                <span class="block text-blue-700 font-normal text-sm">Equipe Samba Vivo</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Rita Lee
                                <span class="block text-blue-700 font-normal text-sm">Equipe Jet</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Cassia Eller
                                <span class="block text-blue-700 font-normal text-sm">Equipe Malandragem</span>
                            </p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="text-gray-900">
                    ...
                    <ul class="mt-2">
                        ...
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Ada Lovelace
                                <span class="block text-blue-700 font-normal text-sm">Equipe Bits</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Margaret Hamilton
                                <span class="block text-blue-700 font-normal text-sm">Equipe Apollo</span>
                            </p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="text-gray-900">
                    ...
                    <ul class="mt-2">
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Cameron Diaz
                                <span class="block text-blue-700 font-normal text-sm">Equipe Pantera</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Britt Lower
                                <span class="block text-blue-700 font-normal text-sm">Equipe Ruptura</span>
                            </p>
                        </li>
                        <li class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100">
                            <span class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4">
                            ...
                            <p class="ml-2 font-bold py-1">
                                Michelle Yeoh
                                <span class="block text-blue-700 font-normal text-sm">Equipe Bagel</span>
                            </p>
                        </li>
                    </ul>
                </div>
